...
export const customerRegister: RequestHandler = async (req, res) => {
...
export const businessRegister: RequestHandler = async (req, res) => {
  const hash = await bcrypt.hash(req.body.password, 10);
...
export const customerLogin: RequestHandler = async (req, res) => {
...
export const businessLogin: RequestHandler = async (req, res) => {
...
export const validateCustomerJWT: RequestHandler = async (req, res) => {
  const JWT_SECRET = process.env.JWT_SECRET!;
...
export const validateBusinessJWT: RequestHandler = async (req, res) => {
  const JWT_SECRET = process.env.JWT_SECRET!;
  const authHeader = req.headers.authorization;
