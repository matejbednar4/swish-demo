...
export const getLoggedInCustomer: RequestHandler = async (req, res, next) => {
...
export const updateLoggedInCustomer: RequestHandler = async (
  req,
  res,
  next
) => {
...
export const createLoggedInCustomerPfp: RequestHandler = async (
  req,
  res,
  next
) => {
...
export const deleteLoggedInCustomer: RequestHandler = async (
  req,
  res,
  next
) => {
