...
export const getRandomBusinesses = async (req, res, next) => {
...
export const getLoggedInBusiness = async (req, res, next) => {
...
export const updateLoggedInBusiness = async (req, res, next) => {
    if (req.user.role !== "BUSINESS") {
        res.status(401).json({ error: "you must be a BUSINESS to do this" });
        return;
    }
...
export const deleteLoggedInBusiness = async (req, res, next) => {
    if (req.user.role !== "BUSINESS") {
        res.status(401).json({ error: "you must be a BUSINESS to do this" });
        return;
    }
